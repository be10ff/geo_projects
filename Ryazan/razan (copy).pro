...
<Project name="Razan" SaveAs="razan.pro" ID="42">
  <Map>
    <Group name="" opacity="1.0" enabled="true" obscure="false">
      ...
      <Layer name="NavitelRyazan.sqlitedb" type="SQL_LAYER" enabled="true">
        ...
        <sqlitedb zoom_type="smart" min="10" max="18" />
      ...
      <Layer name="312_162_10.sqlitedb" type="SQL_YANDEX_LAYER" enabled="false">
        ...
        <sqlitedb zoom_type="auto" min="8" max="18" />
        <Range from="1000000" to="2000" />
      </Layer>
  ...
  <Bounds projection="WGS84" top="55.11521342633033" bottom="54.9452266767913" left="40.233541086705436" right="40.40617646380789" />
  <Edit>
