...
<Project name="Novoriga" SaveAs="novoriga.pro" ID="45">
  <Map>
    <Group name="" opacity="1.0" enabled="true" obscure="false">
      ...
      <Layer name="308_160_10_.sqlitedb" type="SQL_YANDEX_LAYER" enabled="true">
        <Source location="absolute" name="/storage/emulated/0/308_160_10_.sqlitedb" />
        <sqlitedb zoom_type="auto" min="1" max="19" ratio="1" />
        <Range from="233014197" to="888" />
      </Layer>
