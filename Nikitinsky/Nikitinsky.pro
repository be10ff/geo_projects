...
<Project name="Nikitinsky" SaveAs="Nikitinsky.pro" ID="42">
  <Map>
    <Group name="" opacity="1.0" enabled="true" obscure="false">
      ...
      <Layer name="77RUS.sqlitedb" type="SQL_YANDEX_LAYER" enabled="false">
        <Source location="absolute" name="/storage/emulated/0/77RUS.sqlitedb" />
        <sqlitedb zoom_type="auto" min="1" max="19" ratio="3" />
        <Range from="233014197" to="888" />
      </Layer>
