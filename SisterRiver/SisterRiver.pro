...
<Project name="SisterRiver" SaveAs="SisterRiver.pro" ID="45">
  <Map>
    <Group name="" opacity="1.0" enabled="true" obscure="false">
      ...
      <Layer name="308_158_10_new.sqlitedb" type="SQL_YANDEX_LAYER" enabled="false">
        <Source location="absolute" name="/storage/emulated/0/308_158_10_new.sqlitedb" />
        <sqlitedb zoom_type="SMART" min="1" max="20" ratio="1" />
        <Range from="233014197" to="888" />
      </Layer>
      <Layer name="309_158_10_new.sqlitedb" type="SQL_YANDEX_LAYER" enabled="true">
        <Source location="absolute" name="/storage/emulated/0/309_158_10_new.sqlitedb" />
        <sqlitedb zoom_type="SMART" min="1" max="20" ratio="1" />
        <Range from="233014197" to="888" />
      </Layer>
